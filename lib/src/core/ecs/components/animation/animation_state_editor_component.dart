...
final EditorComponentDescriptor kAnimationStateEditorComponent =
    EditorComponentDescriptor(
      ...
      factory: () =>
          AnimationStateComponent(currentAnimation: 'idle', frameCount: 4, frameDuration: 0.1),
      fields: const [],
      fieldGroups: [
        EditorFieldGroup(name: 'Animation', fields: [
          ...
          EditorComponentField(
            ...
            write: (c, v) =>
                (c as AnimationStateComponent).frameDuration = (v as num).toDouble(),
          ),
        ]),

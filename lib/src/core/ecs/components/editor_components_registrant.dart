...
void registerAllEditorComponents() {
  CustomComponentRegistry.instance.registerAll([
    kAnimationStateEditorComponent,
    kAudioSourceEditorComponent,
    kAudioStreamEditorComponent,
    kCameraFollowEditorComponent,
    kTransformEditorComponent,
    kVelocityEditorComponent,
    kEffectEditorComponent,
    kHealthEditorComponent,
    kLifetimeEditorComponent,
    kTagEditorComponent,
    kChildrenEditorComponent,
    kParentEditorComponent,
    kInputEditorComponent,
    kJoystickInputEditorComponent,
    kSimpleMovementEditorComponent,
    kPhysicsBodyCapsuleEditorComponent,
    kPhysicsBodyChainEditorComponent,
    kPhysicsBodyCircleEditorComponent,
    kPhysicsBodyPolygonEditorComponent,
    kPhysicsBodyRoundedRectEditorComponent,
    kPhysicsBodySegmentEditorComponent,
    kPhysicsSensorCapsuleEditorComponent,
    kPhysicsSensorCircleEditorComponent,
    kPhysicsSensorRectEditorComponent,
    kDistanceJointEditorComponent,
    kPrismaticJointEditorComponent,
    kWeldJointEditorComponent,
    kWheelJointEditorComponent,
    // Rect registered last — its fields become the canonical inspector descriptor
    // for all runtime PhysicsBodyComponent instances.
    kPhysicsBodyRectEditorComponent,
    kCapsuleEditorComponent,
    kCircleEditorComponent,
    kLineEditorComponent,
    kPolygonEditorComponent,
    kRectangleEditorComponent,
    kSpriteEditorComponent,
    kButtonEditorComponent,
    kCircularProgressEditorComponent,
    kLinearProgressEditorComponent,
    kTextEditorComponent,
    kUICatalogEditorComponent,
  ]);
}

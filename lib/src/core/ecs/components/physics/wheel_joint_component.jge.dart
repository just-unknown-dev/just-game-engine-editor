...
_$customComponentDescriptor0 = CustomComponentDescriptor(
  id: 'wheeljointcomponent_f1a8a9e1',
  ...
  fields: <EditorComponentField>[
    ...
    EditorComponentField(
      ...
      write: (component, value) {
        (component as WheelJointComponent).maxMotorTorque = (value as num)
            .toDouble();
      },
      enumValues: null,
      enumParser: null,
    ...
    EditorComponentField(
      ...
      write: (component, value) {
        (component as WheelJointComponent).motorSpeed = (value as num)
            .toDouble();
      },
      enumValues: null,
      enumParser: null,
    ...
    EditorComponentField(
      ...
      write: (component, value) {
        (component as WheelJointComponent).stiffness = (value as num)
            .toDouble();
      },
      enumValues: null,
      enumParser: null,
    ...
    EditorComponentField(
      ...
      write: (component, value) {
        (component as WheelJointComponent).targetEntityName = value as String;
      },
      enumValues: null,
      enumParser: null,
    ),
